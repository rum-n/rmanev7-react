...
const About = () => {
    ...
    return (        
        <animated.div style={fade} className='about'>
            ...
            <p>In the past few years, I've been semi-actively getting into web technologies, data science, <span className='data'><a href="www.medium.com/@room_n">writing</a></span>, e-commerce and everything else I find interesting. If you have something you want to share or just want to say hi, feel free to <span className='interests'>drop a line.</span></p> 
